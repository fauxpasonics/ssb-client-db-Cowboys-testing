CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_cust_address_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_cust_address_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445698A3942] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
