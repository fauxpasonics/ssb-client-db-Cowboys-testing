CREATE TABLE [tmarc].[FILE_ssb_cowboy15_20171001_FP_contract_export]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc__FILE_ssb_cowboy15_20171001_FP_contract_export] ON [tmarc].[FILE_ssb_cowboy15_20171001_FP_contract_export]
GO
