CREATE TABLE [working].[Listrak_MessageContactClick]
(
...
GO
ALTER TABLE [working].[Listrak_MessageContactClick] ADD CONSTRAINT [PK__Listrak___3213E83F5386081C] PRIMARY KEY CLUSTERED  ([id])
GO
