CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_cust_donation_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_cust_donation_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24456F80ED7C] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
