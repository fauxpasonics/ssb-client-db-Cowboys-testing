CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_note]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_note] ADD CONSTRAINT [PK__FILE_ssb__C4EA244520225196] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
