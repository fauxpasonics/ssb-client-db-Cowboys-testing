CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_contract_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_contract_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445E66C93C0] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
