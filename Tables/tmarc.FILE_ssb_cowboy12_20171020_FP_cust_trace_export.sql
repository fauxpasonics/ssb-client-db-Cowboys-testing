CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_cust_trace_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_cust_trace_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24452F5E1C36] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
