...
[ETL__SSID_SG_salemode_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[DimSalesCode_V2] ADD CONSTRAINT [PK_dbo__DimSalesCode_V2] PRIMARY KEY CLUSTERED  ([DimSalesCodeId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimSalesCode_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimSalesCode_V2] ([ETL__SourceSystem])
GO
