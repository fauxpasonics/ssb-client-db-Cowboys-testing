CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445CB661C24] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
