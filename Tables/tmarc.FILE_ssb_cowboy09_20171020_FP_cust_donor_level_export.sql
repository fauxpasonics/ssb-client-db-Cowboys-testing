CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_cust_donor_level_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_cust_donor_level_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244528770D23] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
