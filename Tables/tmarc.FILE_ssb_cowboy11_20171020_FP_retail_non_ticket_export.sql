CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_retail_non_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_retail_non_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445A2519811] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
