CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_attend_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_attend_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24458BF359EF] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
