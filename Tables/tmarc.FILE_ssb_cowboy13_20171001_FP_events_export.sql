CREATE TABLE [tmarc].[FILE_ssb_cowboy13_20171001_FP_events_export]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc__FILE_ssb_cowboy13_20171001_FP_events_export] ON [tmarc].[FILE_ssb_cowboy13_20171001_FP_events_export]
GO
