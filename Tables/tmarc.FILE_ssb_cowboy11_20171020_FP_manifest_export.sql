CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_manifest_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_manifest_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24453207736A] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
