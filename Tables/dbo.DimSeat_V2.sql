...
[ETL__SSID_SG_hall_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_SG_venue_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_SG_area_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_SG_areamap_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_SG_SeatIdInAreaMap] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IX_DimSeat_V2_ETL__SourceSystem_ETL__SSID_TM_section_id] ON [dbo].[DimSeat_V2] ([ETL__SourceSystem], [ETL__SSID_TM_section_id], [ETL__SSID_TM_row_id], [ETL__SSID_TM_seat]) WITH (DATA_COMPRESSION = PAGE)
GO
