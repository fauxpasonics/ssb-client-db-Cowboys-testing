CREATE TABLE [api].[Facebook_Staging]
(
[SessionId] [uniqueidentifier] NULL,
[RecordCreateDate] [datetime] NULL CONSTRAINT [DF__FacebookStg__Recor__0880433F] DEFAULT (getdate()),
[Processed] [bit] NULL CONSTRAINT [DF__FacebookStg__Proce__09746778] DEFAULT ((0)),
...
[IsDeleted] [bit] NULL CONSTRAINT [DF__FacebookStg__IsDel__41B8C09B] DEFAULT ((0))
)
GO
