CREATE TABLE [segmentation].[SegmentationFlatDatacd5a568a-a9ea-47f4-8ba2-15db330e6478]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatacd5a568a-a9ea-47f4-8ba2-15db330e6478] ADD CONSTRAINT [pk_SegmentationFlatDatacd5a568a-a9ea-47f4-8ba2-15db330e6478] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatacd5a568a-a9ea-47f4-8ba2-15db330e6478] ON [segmentation].[SegmentationFlatDatacd5a568a-a9ea-47f4-8ba2-15db330e6478] ([_rn])
GO
