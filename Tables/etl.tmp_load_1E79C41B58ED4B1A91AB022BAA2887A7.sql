CREATE TABLE [etl].[tmp_load_1E79C41B58ED4B1A91AB022BAA2887A7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1E79C41B58ED4B1A91AB022BAA2887A7_ss] ON [etl].[tmp_load_1E79C41B58ED4B1A91AB022BAA2887A7] ([SourceSystem], [SSID])
GO
