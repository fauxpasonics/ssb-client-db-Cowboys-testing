CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_audit_raw_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_audit_raw_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445CE9F61D4] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
