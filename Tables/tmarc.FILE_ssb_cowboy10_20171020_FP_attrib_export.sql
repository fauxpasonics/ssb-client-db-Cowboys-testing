CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_attrib_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_attrib_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445C1D0E75B] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
