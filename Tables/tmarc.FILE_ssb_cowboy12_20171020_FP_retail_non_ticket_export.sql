CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_retail_non_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_retail_non_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244597D41408] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
