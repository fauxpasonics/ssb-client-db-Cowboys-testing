CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_cust_address_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_cust_address_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24455441A83E] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
