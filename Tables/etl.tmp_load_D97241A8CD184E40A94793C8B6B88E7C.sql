CREATE TABLE [etl].[tmp_load_D97241A8CD184E40A94793C8B6B88E7C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D97241A8CD184E40A94793C8B6B88E7C_ss] ON [etl].[tmp_load_D97241A8CD184E40A94793C8B6B88E7C] ([SourceSystem], [SSID])
GO
