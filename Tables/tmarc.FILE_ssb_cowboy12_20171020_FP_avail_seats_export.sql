CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_avail_seats_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_avail_seats_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445D1903CB4] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
