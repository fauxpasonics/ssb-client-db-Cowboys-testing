CREATE TABLE [segmentation].[SegmentationFlatDatace900692-55b0-48b4-bc4a-4fc208fd1cbb]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatace900692-55b0-48b4-bc4a-4fc208fd1cbb] ADD CONSTRAINT [pk_SegmentationFlatDatace900692-55b0-48b4-bc4a-4fc208fd1cbb] PRIMARY KEY NONCLUSTERED  ([id])
GO
