...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Creat__049DCCEF] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Updat__0591F128] DEFAULT (getdate()),
