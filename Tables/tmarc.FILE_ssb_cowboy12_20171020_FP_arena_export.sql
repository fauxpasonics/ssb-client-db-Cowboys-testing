CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_arena_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_arena_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445F74D4ECD] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
