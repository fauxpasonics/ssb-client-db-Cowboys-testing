...
[ETL__SSID_SG_promo_code] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[DimPromo_V2] ADD CONSTRAINT [PK_dbo__DimPromo_V2] PRIMARY KEY CLUSTERED  ([DimPromoId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimPromo_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimPromo_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_KEY_TM] ON [dbo].[DimPromo_V2] ([ETL__SSID_TM_promo_code])
GO
