CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_retail_non_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_retail_non_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445CAA416F4] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
