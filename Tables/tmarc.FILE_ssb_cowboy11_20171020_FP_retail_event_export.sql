CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_retail_event_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_retail_event_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445D2837AD0] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
