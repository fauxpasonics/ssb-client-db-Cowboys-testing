CREATE TABLE [segmentation].[SegmentationFlatData2cc8f1bb-64bd-42db-b78f-f2d7d2e3bd15]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData2cc8f1bb-64bd-42db-b78f-f2d7d2e3bd15] ADD CONSTRAINT [pk_SegmentationFlatData2cc8f1bb-64bd-42db-b78f-f2d7d2e3bd15] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData2cc8f1bb-64bd-42db-b78f-f2d7d2e3bd15] ON [segmentation].[SegmentationFlatData2cc8f1bb-64bd-42db-b78f-f2d7d2e3bd15] ([_rn])
GO
