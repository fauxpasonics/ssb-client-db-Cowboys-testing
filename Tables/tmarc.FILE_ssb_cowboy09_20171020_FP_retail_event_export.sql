CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_retail_event_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_retail_event_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244536964931] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
