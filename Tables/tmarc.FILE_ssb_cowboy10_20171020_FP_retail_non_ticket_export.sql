CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_retail_non_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_retail_non_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24455DC250E9] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
