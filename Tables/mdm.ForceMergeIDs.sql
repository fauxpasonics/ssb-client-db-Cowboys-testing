...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Creat__7FD917D2] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Updat__00CD3C0B] DEFAULT (getdate()),
