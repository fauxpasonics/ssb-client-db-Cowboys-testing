CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_donation_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_donation_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445B8DB01F3] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
