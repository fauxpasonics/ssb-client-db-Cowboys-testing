CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_donation_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_donation_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445D43094F9] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
