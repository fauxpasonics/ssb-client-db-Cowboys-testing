CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_contract_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_contract_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445A3971D4D] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
