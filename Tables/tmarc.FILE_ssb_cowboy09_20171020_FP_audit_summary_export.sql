CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_audit_summary_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_audit_summary_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24452D280E50] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
