CREATE TABLE [seat].[TM_payment_schedule_mop]
(
...
GO
ALTER TABLE [seat].[TM_payment_schedule_mop] ADD CONSTRAINT [PK__FILE__ss__C4EA2445F1FB89C9] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
