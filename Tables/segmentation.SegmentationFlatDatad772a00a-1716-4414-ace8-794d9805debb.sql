CREATE TABLE [segmentation].[SegmentationFlatDatad772a00a-1716-4414-ace8-794d9805debb]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatad772a00a-1716-4414-ace8-794d9805debb] ADD CONSTRAINT [pk_SegmentationFlatDatad772a00a-1716-4414-ace8-794d9805debb] PRIMARY KEY NONCLUSTERED  ([id])
GO
