...
[ETL__SSID_SG_pricelevel_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[DimPriceLevel_V2] ADD CONSTRAINT [PK_dbo__DimPriceLevel_V2] PRIMARY KEY CLUSTERED  ([DimPriceLevelId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimPriceLevel_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimPriceLevel_V2] ([ETL__SourceSystem])
GO
