CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_sellloc_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_sellloc_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244572CC0B97] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
