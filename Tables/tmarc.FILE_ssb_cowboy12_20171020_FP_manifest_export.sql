CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_manifest_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_manifest_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244593A17F64] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
