...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Creat__01C16044] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Updat__02B5847D] DEFAULT (getdate()),
