CREATE TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_audit_summary_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy11_20171020_FP_audit_summary_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445E606DE16] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
