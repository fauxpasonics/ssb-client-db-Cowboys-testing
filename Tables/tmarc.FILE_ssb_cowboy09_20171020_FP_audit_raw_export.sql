CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_audit_raw_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_audit_raw_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445CA7C1E16] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
