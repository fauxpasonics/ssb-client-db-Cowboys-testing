CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_attrib_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_attrib_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244511D0C112] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
