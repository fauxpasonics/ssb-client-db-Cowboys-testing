CREATE TABLE [tmarc].[FILE_ssb_cowboy16_20171001_FP_avail_seats_export]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc__FILE_ssb_cowboy16_20171001_FP_avail_seats_export] ON [tmarc].[FILE_ssb_cowboy16_20171001_FP_avail_seats_export]
GO
