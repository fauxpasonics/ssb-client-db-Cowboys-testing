CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_inv_line_item_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_inv_line_item_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244553298C27] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
