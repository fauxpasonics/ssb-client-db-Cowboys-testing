...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____1B00AA76] DEFAULT (getdate()),
[ETL__UpdatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____1BF4CEAF] DEFAULT (getdate()),
