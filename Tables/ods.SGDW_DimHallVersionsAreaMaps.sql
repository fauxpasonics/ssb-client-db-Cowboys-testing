CREATE TABLE [ods].[SGDW_DimHallVersionsAreaMaps]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__SGDW_DimHallVersionsAreaMaps] ON [ods].[SGDW_DimHallVersionsAreaMaps]
GO
