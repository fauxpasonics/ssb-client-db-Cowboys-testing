CREATE TABLE [seat].[TM_retail_non_ticket]
(
...
GO
ALTER TABLE [seat].[TM_retail_non_ticket] ADD CONSTRAINT [PK__FILE__ss__C4EA244531C9C529] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
