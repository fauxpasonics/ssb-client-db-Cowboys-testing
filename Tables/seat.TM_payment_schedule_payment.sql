CREATE TABLE [seat].[TM_payment_schedule_payment]
(
...
GO
ALTER TABLE [seat].[TM_payment_schedule_payment] ADD CONSTRAINT [PK__FILE__ss__C4EA2445FF73B795] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
