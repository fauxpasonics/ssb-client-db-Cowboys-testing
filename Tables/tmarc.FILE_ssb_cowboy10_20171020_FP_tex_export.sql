CREATE TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_tex_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy10_20171020_FP_tex_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445ABE4B1FB] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
