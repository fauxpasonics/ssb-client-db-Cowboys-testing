...
[ETL__SSID_event_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_sector_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_seat_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ETL__SSID_client_guid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IX_FactAttendance_V2_DimEventId_DimSeatId] ON [dbo].[FactAttendance_V2] ([DimEventId], [DimSeatId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_FactAttendance_V2_ETL__UpdatedDate] ON [dbo].[FactAttendance_V2] ([ETL__UpdatedDate]) WITH (DATA_COMPRESSION = PAGE)
GO
