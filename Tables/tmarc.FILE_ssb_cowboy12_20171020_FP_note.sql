CREATE TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_note]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy12_20171020_FP_note] ADD CONSTRAINT [PK__FILE_ssb__C4EA24452F1E4A81] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
