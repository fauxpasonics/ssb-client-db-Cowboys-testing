CREATE TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_avail_seats_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_cowboy09_20171020_FP_avail_seats_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24457AFC8A00] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
