...
EXEC [etl].[JSONTranslator] @Step = ''''Run ETL'''', @StageSchema = ''''' + t.[Schema] + ''''', @TableName = ''''' + t.[Name] + ''''', @SuppressPrint = 1,@RunFullSession = ' +
 CASE WHEN tcon.TargetTableName in ('') then '0' ELSE '1' END + '
