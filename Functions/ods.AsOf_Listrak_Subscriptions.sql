...
SELECT * FROM [ods].[AsOf_Listrak_Subscriptions] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_Listrak_Subscriptions] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_Listrak_Subscriptions]
	) a
WHERE
