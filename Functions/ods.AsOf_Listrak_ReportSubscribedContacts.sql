...
SELECT * FROM [ods].[AsOf_Listrak_ReportSubscribedContacts] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_Listrak_ReportSubscribedContacts] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Listrak_ReportSubscribedContacts] t
	UNION ALL
	...
	FROM [ods].[Snapshot_Listrak_ReportSubscribedContacts]
	) a
WHERE
